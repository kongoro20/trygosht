...
verif_button_image = 'verif_button.png'
verif1_button_image = 'verif1_button.png'
...
for attempt in range(max_attempts):
    ...
    try:
        ...
        button_location = pyautogui.locateOnScreen(verif_button_image, confidence=0.65)
    ...
    try:
        ...
        button_location = pyautogui.locateOnScreen(verif1_button_image, confidence=0.65)
    except Exception as e:
